...
var (
	accessID   = "dcocschE0RsKNJ7G"
	accessKey  = "Ib86whviPt9tLussFO05CQ7n5fohlG"
	testBucket = "testcasepinidea015"
	testRegion = HangZhou
...
func TestURL(t *testing.T) {
	...
	if url != "http://" + testBucket + ".oss-cn-hangzhou.aliyuncs.com/readme" {
